      ...
      <header class="main-header">               
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-header">
            <a href="<?php echo site_url();?>" class="navbar-brand">Codeigniter <b>Invoice System</b></a>
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Click here to Start<span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                      ...
                      <li><a href="<?php echo site_url('ajaxform');?>">Add Item in Ajax method</a></li>
                  </ul>
                </li>
            </ul>
          </div><!-- /.navbar-collapse -->
